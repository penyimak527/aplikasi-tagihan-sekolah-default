    ...
    <div class="receipt">
        ...
        <?php foreach ($detail as $d): ?>
            <div class="detail-row">
                ...
                <div class="detail-amount"><?= rupiah($d['nominal_bayar']) ?></div>
            </div>
        <?php endforeach; ?>

        <div class="line"></div>
        <div class="row-data total"><span>TOTAL</span><span><?= rupiah($header['total_pembayaran']) ?></span></div>
        <?php if (($f['tampilkan_uang_diterima'] ?? 'Ya') === 'Ya'): ?>
            <div class="row-data"><span>Uang Diterima</span><span><?= rupiah($header['uang_diterima']) ?></span></div>
        <?php endif; ?>
        <?php if (($f['tampilkan_kembalian'] ?? 'Ya') === 'Ya'): ?>
            <div class="row-data"><span>Kembalian</span><span><?= rupiah($header['kembalian']) ?></span></div>
        <?php endif; ?>
        <?php if (($f['tampilkan_sisa_tagihan'] ?? 'Ya') === 'Ya'): ?>
            <div class="row-data"><span>Sisa Tagihan</span><span><?= rupiah($sisaTotal) ?></span></div>
        <?php endif; ?>
