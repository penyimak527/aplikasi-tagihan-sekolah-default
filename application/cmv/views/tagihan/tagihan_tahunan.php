<?php $endpoint = 'tagihan/tagihan_tahunan'; ?>
<div class="card">
        ...
        <form id="form_tagihan">
            ...
            <div class="card border mt-4 mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4"><label class="form-label">Bulan Mulai Tampil</label><select name="bulan_penagihan" id="bulan_penagihan" class="form-select"><?php foreach (range(1, 12) as $m): ?><option value="<?= $m ?>"><?= nama_bulan($m) ?></option><?php endforeach; ?></select></div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.fire({
                            ...
                            if (data.result == 'true') {
                                window.location.href = '<?= base_url('tagihan/daftar_tagihan'); ?>';
                            }
                        });
                    },
                    error: function(xhr, status, error) {
