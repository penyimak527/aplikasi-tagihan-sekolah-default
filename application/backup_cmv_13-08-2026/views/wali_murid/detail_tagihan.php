            ...
            foreach ($cicilan as $row): ?>
                <div class="border rounded p-3 mb-2 d-flex justify-content-between gap-3 flex-wrap">
                    <div>
                        ...
                        <div><?= rupiah($row['nominal_bayar']) ?> | <?= html_escape($row['nama_metode_pembayaran']) ?> <span
