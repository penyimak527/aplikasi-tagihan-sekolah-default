                ...
                <form id="form" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_format" id="nama" class="form-control"
                                placeholder="Contoh: Bukti 80mm" required>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="judul_bukti" id="judul" class="form-control"
                        ...
                        <div class="col-12 d-none" id="custom_size_area">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.1" min="1" name="lebar_kertas" id="lebar_kertas"
                                        class="form-control" placeholder="Contoh: 80">
                                </div>
                                <div class="col-md-6">
                                    <label for="tinggi_kertas" class="form-label">Tinggi Kertas Custom (mm)</label>
                                    <input type="number" step="0.1" min="1" name="tinggi_kertas" id="tinggi_kertas"
                                        class="form-control" placeholder="Contoh: 200">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_sekolah" id="sekolah" class="form-control"
                                value="<?= html_escape(config_item('nama_sekolah') ?: 'Sekolah') ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="header_cetak" id="header_cetak" class="form-control" rows="2"
                                placeholder="Teks tambahan di bawah identitas sekolah"></textarea>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.1" min="0" name="margin_atas" id="ma" class="form-control"
                                value="5">
                        </div>
                        <div class="col-md-3">
                            <label for="mb" class="form-label">Bawah</label>
                            <input type="number" step="0.1" min="0" name="margin_bawah" id="mb" class="form-control"
                                value="5">
                        </div>
                        <div class="col-md-3">
                            <label for="mk" class="form-label">Kiri</label>
                            <input type="number" step="0.1" min="0" name="margin_kiri" id="mk" class="form-control"
                                value="5">
                        </div>
                        <div class="col-md-3">
                            <label for="mka" class="form-label">Kanan</label>
                            <input type="number" step="0.1" min="0" name="margin_kanan" id="mka" class="form-control"
                                value="5">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="footer_cetak" id="footer_cetak" class="form-control" rows="2"
                                placeholder="Contoh: Simpan bukti ini sebagai tanda pembayaran yang sah"></textarea>
                        </div>
                    </div>
...
<script>
    $(function() {
        ...
        function load() {
            $.getJSON('<?= base_url('admin/pengaturan/format_bukti/result') ?>', function(response) {
                rows = response || [];
                if (!rows.length) {
        ...
        $(document).on('click', '.def', function() {
            ...
            confirmAction('Jadikan format default?', 'Format default sebelumnya akan diganti.', function() {
                $.post('<?= base_url('admin/pengaturan/format_bukti/set_default') ?>', {
                    id: id
                }, function(response) {
        ...
        $('#form').on('submit', function(event) {
            ...
            $.ajax({
                url: '<?= base_url('admin/pengaturan/format_bukti/simpan') ?>',
                method: 'POST',
