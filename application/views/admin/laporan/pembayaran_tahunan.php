...
$(document).ready(function () {
    ...
    function loadReport() {
        ...
        $.ajax({
            url: '<?= base_url('admin/laporan/laporan/result/tahunan') ?>',
            type: 'POST',
            data: reportData(),
            dataType: 'JSON',
    ...
    $('#cetak').on('click', function () {
        var url = '<?= base_url('admin/data_laporan/pembayaran_tahunan') ?>?' + new URLSearchParams(reportData()).toString();
        window.open(url, '_blank');
    });
    $('#export').on('click', function () {
        this.href = '<?= base_url('admin/laporan/laporan/export/tahunan') ?>?' + new URLSearchParams(reportData()).toString();
    });
