    ...
    <div class="card-body">
        <div class="row g-3 align-items-end" id="filters">
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <input type="text" id="filter_tanggal" class="form-control tanggal-picker" value="<?= date('d-m-Y') ?>" placeholder="dd-mm-yyyy" autocomplete="off">
            </div>
            <div class="col-md-6 col-xl-3">
            ...
            <div class="col-md-6 col-xl-2">
                ...
                <input id="filter_petugas" class="form-control" placeholder="Nama petugas">
            </div>
            <div class="col-md-6 col-xl-2">
                <label class="form-label" for="filter_status_laporan">Status</label>
                <select id="filter_status_laporan" class="form-select">
...
$(document).ready(function () {
    ...
    function reportData() {
        return {
            ...
            status: $('#filter_status_laporan').val()
        };
    }
    ...
    function loadReport() {
        ...
        $.ajax({
            url: '<?= base_url('admin/laporan/laporan/result/harian') ?>',
            type: 'POST',
            data: reportData(),
            dataType: 'JSON',
    ...
    $('#cetak').on('click', function () {
        var url = '<?= base_url('admin/data_laporan/pembayaran_harian') ?>?' + new URLSearchParams(reportData()).toString();
        window.open(url, '_blank');
    });
    $('#export').on('click', function () {
        this.href = '<?= base_url('admin/laporan/laporan/export/harian') ?>?' + new URLSearchParams(reportData()).toString();
    });
