    ...
    <div class="card-body">
        <div class="row g-3 align-items-end" id="filters">
            ...
            <div class="col-md-6 col-xl-3">
                ...
                <input id="filter_q" class="form-control" placeholder="Cari nomor transaksi atau siswa">
            </div>
            <div class="col-md-6 col-xl-3">
                <label class="form-label" for="filter_awal">Tanggal Awal</label>
                <input type="text" id="filter_awal" class="form-control tanggal-picker" placeholder="dd-mm-yyyy" autocomplete="off">
            </div>
            <div class="col-md-6 col-xl-3">
                <label class="form-label" for="filter_akhir">Tanggal Akhir</label>
                <input type="text" id="filter_akhir" class="form-control tanggal-picker" placeholder="dd-mm-yyyy" autocomplete="off">
            </div>
            <div class="col-md-6 col-xl-3">
                <label class="form-label" for="filter_petugas">Petugas Pembatal</label>
                <input id="filter_petugas" class="form-control" placeholder="Nama petugas pembatal">
            </div>
        </div>
...
$(document).ready(function () {
    ...
    function loadReport() {
        ...
        $.ajax({
            url: '<?= base_url('admin/laporan/laporan/result/pembatalan') ?>',
            type: 'POST',
            data: reportData(),
            dataType: 'JSON',
    ...
    $('#cetak').on('click', function () {
        var url = '<?= base_url('admin/data_laporan/riwayat_pembatalan') ?>?' + new URLSearchParams(reportData()).toString();
        window.open(url, '_blank');
    });
    $('#export').on('click', function () {
        this.href = '<?= base_url('admin/laporan/laporan/export/pembatalan') ?>?' + new URLSearchParams(reportData()).toString();
    });
