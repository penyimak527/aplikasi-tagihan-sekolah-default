...
$(document).ready(function () {
    ...
    function loadReport() {
        ...
        $.ajax({
            url: '<?= base_url('admin/laporan/laporan/result/per_jenis') ?>',
            type: 'POST',
            data: reportData(),
            dataType: 'JSON',
    ...
    $('#cetak').on('click', function () {
        var url = '<?= base_url('admin/data_laporan/rekap_per_jenis') ?>?' + new URLSearchParams(reportData()).toString();
        window.open(url, '_blank');
    });
    $('#export').on('click', function () {
        this.href = '<?= base_url('admin/laporan/laporan/export/per_jenis') ?>?' + new URLSearchParams(reportData()).toString();
    });
