        ...
        <form id="form_tagihan">
            ...
            <div class="card border mt-4 mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4"><label class="form-label">Bulan Tagihan</label><select name="bulan_penagihan" id="bulan_penagihan" class="form-select"><?php foreach (range(1, 12) as $m): ?><option value="<?= $m ?>"><?= nama_bulan($m) ?></option><?php endforeach; ?></select></div>
...
<script>
    ...
    function cariSiswa() {
        ...
        $.ajax({
            url: '<?= base_url('admin/tagihan/tagihan_langsung/cari_siswa'); ?>',
            type: 'POST',
            data: {
                q: $('#cari_siswa').val(),
    ...
    function preview() {
        ...
        $.ajax({
            url: '<?= base_url('admin/tagihan/tagihan_langsung/preview'); ?>',
            type: 'POST',
    ...
    function simpan(mode) {
        confirmAction(
            ...
            function() {
                ...
                $.ajax({
                    url: '<?= base_url('admin/tagihan/tagihan_langsung/simpan'); ?>',
                    type: 'POST',
                    data: formData(mode),
                    dataType: 'JSON',
                    success: function(data) {
