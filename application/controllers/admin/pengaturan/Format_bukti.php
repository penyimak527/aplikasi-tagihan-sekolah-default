...
class Format_bukti extends CI_Controller
{
    ...
    {
        $data = array('title' => 'Format Bukti Pembayaran');
    ...
    {
        $this->json_response($this->model->format_list('Bukti Pembayaran'));
    }
    ...
    {
        $this->json_response($this->model->format_save('Bukti Pembayaran'));
    }
