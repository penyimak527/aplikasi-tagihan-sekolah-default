...
<div id="area_transaksi" class="d-none">
    ...
    <div class="card" id="penyelesaian-pembayaran">
        <div class="card-header app-card-header">
            <div>
                <h4 class="header-title mb-1">4. Penyelesaian Pembayaran</h4>
        ...
        <div class="card-body">
            <form id="form_pembayaran">
                ...
                <div class="row g-3">
                    ...
                    <div id="blok_tunai" class="col-12 d-none">
                        <div class="row g-3">
                            <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="catatan" class="form-control" rows="3" placeholder="Catatan transaksi bila diperlukan"></textarea>
                    </div>

                    <div class="col-12">
                        <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 border-top pt-3">
                            <button type="button" id="btn_kembali_keranjang" class="btn btn-light">
                                <i class="ri-arrow-up-line me-1"></i>Kembali ke Keranjang
                            </button>
...
$(function () {
    ...
    $('#btn_kembali_keranjang').click(function () {
        document.getElementById('keranjang-pembayaran').scrollIntoView({
            behavior: 'smooth',
            block: 'start'
        });
    });
