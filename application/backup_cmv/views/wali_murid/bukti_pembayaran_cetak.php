...
<body>
    ...
    <div class="receipt">
        ...
        <div class="line"></div>
        <?php foreach ($detail as $d): ?><div class="row"><span><?= html_escape($d['nama_tagihan']) ?><?= $d['status_detail'] !== 'Aktif' ? ' (Dibatalkan)' : '' ?></span><span><?= rupiah($d['nominal_bayar']) ?></span></div><?php endforeach; ?>
        <div class="line"></div>
        <div class="row total"><span>TOTAL</span><span><?= rupiah($header['total_pembayaran']) ?></span></div>
        <?php if (($f['tampilkan_uang_diterima'] ?? 'Ya') === 'Ya'): ?><div class="row"><span>Uang Diterima</span><span><?= rupiah($header['uang_diterima']) ?></span></div><?php endif; ?>
        <?php if (($f['tampilkan_kembalian'] ?? 'Ya') === 'Ya'): ?><div class="row"><span>Kembalian</span><span><?= rupiah($header['kembalian']) ?></span></div><?php endif; ?>
        <?php if (($f['tampilkan_sisa_tagihan'] ?? 'Ya') === 'Ya'): ?><div class="row"><span>Sisa Tagihan</span><span><?= rupiah($sisaTotal) ?></span></div><?php endif; ?>
