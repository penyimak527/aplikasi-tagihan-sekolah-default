...
$(document).ready(function () {
    ...
    $('#periode_asal').on('change', function () { filterKelasKenaikan('asal'); });
    $('#periode_tujuan').on('change', function () {
        filterKelasKenaikan('tujuan');
        loadSiswaKenaikan();
    });
    $('#kelas_asal, #kelas_tujuan').on('change', loadSiswaKenaikan);
...
function loadSiswaKenaikan() {
    ...
    $.post('<?= base_url('admin/kesiswaan/kenaikan_kelas/siswa') ?>', {
        id_kelas_setting: id,
