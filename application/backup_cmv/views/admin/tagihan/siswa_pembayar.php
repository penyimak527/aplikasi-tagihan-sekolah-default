...
function loadData() {
    ...
    $.post('<?= base_url('admin/tagihan/siswa_pembayar/result') ?>', {
        id_tagihan: id,
        search: $('#search').val()
    }, function (response) {
...
function tambah() {
    ...
    confirmAction(
        ...
        function () {
            $.post('<?= base_url('admin/tagihan/siswa_pembayar/tambah') ?>', {
...
function keluarkan(id) {
    confirmAction(
        ...
        function () {
            $.post('<?= base_url('admin/tagihan/siswa_pembayar/keluarkan') ?>', {
                id_tagihan: $('#tagihan').val(),
                id_siswa: id
            }, function (response) {
                var berhasil = response.result === 'true';
