...
class M_monitoring_tagihan extends CI_Model
{
    ...
    public function per_siswa()
    {
        ...
        if (!$siswa) return model_response(false, 'Siswa tidak ditemukan.');
        ...
        if ($sampai) $this->db->where('bulan <=', $sampai);
    ...
    public function per_kelas()
    {
        ...
        foreach ($rows as &$r) {
            $jumlahTagihan = (int)$r['jumlah_tagihan'];
    ...
    public function per_jenis()
    {
        ...
        $master = (int)$this->input->post('id_master');
        $kelas = (int)$this->input->post('id_kelas_setting');
    ...
    public function tunggakan_lama()
    {
        $tahunBerjalan = (int)$this->input->post('id_periode_berjalan');
        $kelas = (int)$this->input->post('id_kelas_setting');
