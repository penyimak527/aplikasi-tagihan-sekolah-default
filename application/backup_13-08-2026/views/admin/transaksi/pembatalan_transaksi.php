    ...
    <div class="card-body">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-2">
                ...
                <input type="text" id="filter_awal" class="form-control tanggal" placeholder="Tanggal Awal">
            </div>
            <div class="col-md-2">
                <label class="form-label" for="filter_akhir">Tanggal Akhir</label>
                <input type="text" id="filter_akhir" class="form-control tanggal" placeholder="Tanggal Akhir">
            </div>
            <div class="col-md-2">
...
function loadTransactions() {
    ...
    $.ajax({
        url: '<?= base_url('admin/transaksi/pembatalan_transaksi/result'); ?>',
        type: 'POST',
        data: {
            q: $('#filter_q').val(),
...
function showDetail(id) {
    $.ajax({
        url: '<?= base_url('admin/transaksi/pembatalan_transaksi/detail'); ?>',
        type: 'POST',
        data: {
            id: id
        },
...
function cancelTransaction() {
    ...
    $.ajax({
        url: '<?= base_url('admin/transaksi/pembatalan_transaksi/batalkan'); ?>',
        type: 'POST',
        data: {
            id: id,
            alasan: reason
