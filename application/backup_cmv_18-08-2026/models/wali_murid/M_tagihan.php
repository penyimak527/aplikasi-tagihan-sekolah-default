...
class M_tagihan extends CI_Model
{
    ...
    public function detail($id_wali, $id_tagihan)
    {
        ...
        if (!$tagihan) return $this->model_response(false, 'Tagihan tidak ditemukan.');
        ...
        if (!$valid) return $this->model_response(false, 'Tagihan tidak dapat diakses oleh akun ini.');
        ...
        return $this->model_response(true, 'Detail tagihan berhasil dimuat.', array('tagihan' => $tagihan, 'cicilan' => $cicilan));
    }
