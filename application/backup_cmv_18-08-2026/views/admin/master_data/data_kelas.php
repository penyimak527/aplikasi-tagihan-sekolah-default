...
function loadData() {
    $.post('<?= base_url('admin/master_data/data_kelas/result') ?>', {
        search: $('#search').val(),
...
function detailData(id) {
    ...
    modalDetail.show();
    $.post('<?= base_url('admin/master_data/data_kelas/detail') ?>', {id: id}, function (response) {
...
function saveData() {
    ...
    $.post('<?= base_url('admin/master_data/data_kelas/simpan') ?>', $('#form').serialize(), function (response) {
...
function hapus(id) {
    confirmAction('Hapus kelas?', 'Kelas yang sudah digunakan tidak dapat dihapus.', function () {
        $.post('<?= base_url('admin/master_data/data_kelas/hapus') ?>', {id: id}, function (response) {
            const berhasil = response.result === 'true';
            Swal.fire(berhasil ? 'Berhasil' : 'Gagal', response.message, berhasil ? 'success' : 'error');
