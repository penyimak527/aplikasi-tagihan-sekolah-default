...
$(document).ready(function () {
    ...
    function reset_filter() {
        ...
        $('#filter_kelas,#filter_jenis,#filter_metode,#filter_periode_jenis').val('');
    ...
    function atur_form_laporan() {
        ...
        if (laporanAktif === 'tunggakan') {
            // Sampai Bulan disembunyikan dan fungsi waktunya diwakili Hari/Bulan/Tahun.
            tampil_field(['field-periode','field-kelas','field-jenis','field-status-siswa']);
            return;
        }
