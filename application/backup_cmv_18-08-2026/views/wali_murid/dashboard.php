                ...
                <div class="card portal-card h-100">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="portal-stat-value"><?= $format_rupiah($card[1]) ?></div>
                        </div>
                                ...
                                <div class="d-flex justify-content-between gap-3 flex-wrap">
                                    <div>
                                        ...
                                        <small class="text-muted">Sisa
                                            <?= $format_rupiah($row['sisa_tagihan']) ?>            <?= $row['tanggal_jatuh_tempo'] ? ' • Jatuh tempo ' . html_escape($row['tanggal_jatuh_tempo']) : '' ?></small>
                                    </div>
                        ...
                        foreach ($pembayaran_terbaru as $row): ?>
                            <div class="border-bottom pb-3 mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center gap-2">
                                    <strong><?= $format_rupiah($row['total_pembayaran']) ?></strong><a target="_blank"
