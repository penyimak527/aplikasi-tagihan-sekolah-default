...
{
    public function __construct(){parent::__construct();$this->load->model('tagihan/M_keringanan','model');}
    public function index(){$data = array('title'=>'Potongan atau Pembebasan');
